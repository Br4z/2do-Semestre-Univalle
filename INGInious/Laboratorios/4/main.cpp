/*
    ...
    Email:
    Fecha creación: 2022-05-03
    Fecha última modificación: 2022-05-03
    Versión: 0.1
    Licencia: GPL
*/
...
/**
    HISTORIA:
    Estamos en el concurso de televisión ¿ Quieres ser trillonario ? Los ganadores están en fila para 
    recibir el premio El premio, y también hay una fila de presentadores para entregarlos. Hay distintos 
...
int main()
{
    ...
    vector<string> nombresPersonas = {"Sofía", 
    "Esteban", 
    "Antonio", 
    "Rosita", 
    "Ana", 
